...
**
** Created: Sun Jan 1 15:32:27 2012
...
public:
    ...
    void setupUi(QDialog *LootItemEditor)
    {
        ...
        tableWidget_ExperimentalProperties->setSelectionBehavior(QAbstractItemView::SelectRows);
        ...
        tableWidget_CustomizationVariables->setSelectionBehavior(QAbstractItemView::SelectRows);
