...
class FloorMeshTriangleNode : public TriangleNode {
	...
	sys::byte /*hasNorthWestTriangle, hasNorthEastTriangle, hasSouthTriangle,*/ var14;
...
public:
	...
	inline FloorMeshTriangleNode* getTriangle(int index) {
	...
	inline void setCellID(int id) {
		if (cellID != -1)
			System::out << "UIWBIUGFISUBGSFIUBGSODIFGN" << sys::lang::endl;
