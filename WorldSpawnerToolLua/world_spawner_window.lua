...
local function disableAreaInfoControls()
    ...
    WorldSpawnerWindow.areaShape:Enable(false)
    ...
    WorldSpawnerWindow.worldSpawnType:Enable(false)
    WorldSpawnerWindow.buildings:Enable(false)
    WorldSpawnerWindow.spawnGroups:Enable(false)
    WorldSpawnerWindow.nofSpawns:Enable(false)
end

local function enableAreaInfoControls()
    WorldSpawnerWindow.xCoord:Enable(true)
    WorldSpawnerWindow.yCoord:Enable(true)
    WorldSpawnerWindow.areaShape:Enable(true)
    ...
    WorldSpawnerWindow.worldSpawnType:Enable(true)
    WorldSpawnerWindow.buildings:Enable(true)
    WorldSpawnerWindow.spawnGroups:Enable(true)
    WorldSpawnerWindow.nofSpawns:Enable(true)
end
