...
private slots:
    ...
    void btIDChangedCallback(const QModelIndex& topLeft, const QModelIndex& botRght);
    void dtIDChangedCallback(const QModelIndex& topLeft, const QModelIndex& botRght);
	void insertChild();
	void openFileDialog();
    void openDirDialog();
    void clear();
